...
<div class="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
    ...
    <!-- FILTER -->
    <div class="bg-white p-4 sm:p-5 rounded-xl shadow space-y-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <!-- Tanggal -->
            <div>
                <label class="text-xs sm:text-sm text-gray-600">Tanggal</label>
                <input type="date"
            ...
            <!-- Kategori -->
            <div>
                <label class="text-xs sm:text-sm text-gray-600">Kategori</label>
