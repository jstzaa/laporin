...
Route::middleware('auth:admin')->group(function(){
    ...
    Route::get('/admin/kategori/{id}', [Admin\KategoriController::class, 'edit'])->name('show.edit.kategori');
    ...
    Route::get('/admin/daftar-siswa/edit-siswa/{id}', [Admin\SiswaController::class, 'edit'])->name('show.edit.siswa');
    Route::put('/admin/daftar-siswa/edit-siswa/{id}', [Admin\SiswaController::class, 'update'])->name('update.siswa');
    ...
    Route::get('/admin/daftar-admin/edit-admin/{id}', [Admin\AdminManageController::class, 'edit'])->name('show.edit.admin');
    Route::put('/admin/daftar-admin/edit-admin/{id}', [Admin\AdminManageController::class, 'update'])->name('update.admin');
